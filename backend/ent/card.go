...
func (e CardEdges) ItemsOrErr() ([]*Item, error) {
	if e.loadedTypes[0] {
		return e.Items, nil
	}
...
// QueryItems queries the "items" edge of the Card entity.
func (c *Card) QueryItems() *ItemQuery {
	return NewCardClient(c.config).QueryItems(c)
}
